...
class Config(object):
  ...
  AWS_SNS_JOB_REQUEST_TOPIC = \
    "zhangzx_job_requests"
  AWS_SNS_JOB_COMPLETE_TOPIC = \
    "zhangzx_job_results"

  AWS_SNS_GLACIER_TOPIC = \
    "zhangzx-glacier-restore"

  # Change the table name to your own
  AWS_DYNAMODB_ANNOTATIONS_TABLE = "zhangzx_annotations"

  # Change the email address to your username
  MAIL_DEFAULT_SENDER = "zhangzx@mpcs-cc.com"
